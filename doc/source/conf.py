...
sys.path.insert(0, os.path.abspath('../../climate'))
...
#
# Version info
from climate.version import version_info as climate_version
release = climate_version.release_string()
# The short X.Y version.
version = climate_version.version_string()
